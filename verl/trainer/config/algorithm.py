...
__all__ = ["AlgoConfig", "FilterGroupsConfig", "KLControlConfig", "RolloutCorrectionConfig", "CodaConfig"]
...
@dataclass
class CodaConfig(BaseConfig):
    """Configuration for CODA.
    ...
    # New params for CODA
    easy_len_penalty_coef: float = 0.2
    hard_len_reward_coef: float = 0.2
